...
class GridEditingTest {
    ...
    @Test fun `full page insertion spills past widget cells at start of next page`() {
        ...
        // The widget blocks the next page's first row (4 cells); the displaced last cell lands
        // in the first free cell past it.
        assertEquals((HOME_CELLS - 1).toString(), next.slots[HOME_CELLS + 4])
