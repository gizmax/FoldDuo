...
class SystemShadeIntegrationTest {
    ...
    private val component = "cz.pflanzer.foldduo/cz.pflanzer.foldduo.SystemShadeAccessibilityService"
    ...
    @Test fun enabledServiceOpensNotificationsAndExpandedQuickSettings() {
        ...
        try {
            ...
            stage = "collapse"
            await {
                automation.rootInActiveWindow?.packageName?.toString() == "cz.pflanzer.foldduo" &&
            ...
            assertEquals("cz.pflanzer.foldduo", automation.rootInActiveWindow?.packageName?.toString())
