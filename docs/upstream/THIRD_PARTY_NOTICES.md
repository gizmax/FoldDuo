...
- `pose/` and `continuum/` contain code ported from [marcoazeem/duo-open](https://github.com/marcoazeem/duo-open)
  (MIT, Copyright (c) 2026 marcoazeem): `HingeAngleSource`, `TiltFollower`, panel detection,
  `FoldShader`/`FoldLine`, `Modifier.foldEffect`, and `res/raw/fold_morph.agsl`. License text: `LICENSE-duo-open`.
- Nothing is taken from Atomicx7/Duo-animation (no license published).
